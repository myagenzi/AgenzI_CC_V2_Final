  ...
  return (
    <footer className="border-t border-foreground/[0.06]">
      <div className="mx-auto flex max-w-[1100px] flex-col items-center gap-6 px-6 py-12 text-center lg:px-12">
        <img src={logo} alt="AgenzI" className="h-48 w-auto drop-shadow-sm" />
        <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-[13px] text-foreground/55" aria-label="Footer">
          <a data-magnify href="/what-we-do/creative-caas" className="hover:text-foreground">CaaS</a>
          <a data-magnify href="/what-we-do/marketing-maas" className="hover:text-foreground">MaaS</a>
          <a data-magnify href="/what-we-do/intelligence-zenzai" className="hover:text-foreground">Zenzai</a>
